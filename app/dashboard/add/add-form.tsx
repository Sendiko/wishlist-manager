    ...
    return (
        <form action={action} className="space-y-6">
            ...
            <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
                <label htmlFor="photo" className="block text-sm font-medium text-gray-700 mb-2">Upload Foto</label>
                <input
                    type="file"
                    id="photo"
                    name="photo"
        ...
        hover:file:bg-blue-100"
                />
                <p className="mt-2 text-xs text-gray-500">Atau masukkan URL foto di bawah:</p>
            </div>
